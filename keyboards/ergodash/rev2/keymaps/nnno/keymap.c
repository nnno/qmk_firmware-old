...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LANG2,                        KC_EQL , KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,  \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LOWER   ,                        RAISE  , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LALT, KC_LGUI, KC_LANG1,         KC_SPC,  LOWER   ,_______,        _______,RAISE  , KC_ENT,           KC_LEFT, KC_LBRC, KC_RBRC, KC_RGHT  \
  ),

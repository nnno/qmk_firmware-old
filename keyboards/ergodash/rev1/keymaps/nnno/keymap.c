...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT( \
    ...
    KC_ESC , _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______, KC_PIPE, \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC,                        KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, \
    _______, _______, _______, _______, _______, _______,  LOWER ,                         RAISE , KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, \
  ...
  [_LOWER] = LAYOUT( \
    ...
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_LCBR,                        KC_RCBR, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DQT , \
    _______, _______, _______, _______, _______, _______,  LOWER ,                         RAISE , KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______, \
